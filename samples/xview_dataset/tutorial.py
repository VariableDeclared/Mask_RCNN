...
dataset_train.load_data('../datasets/xview_dataset/xview_data.train.json', '../datasets/xview_dataset/class_ids.json', '../datasets/xview_dataset/train_images')
dataset_train.prepare()

dataset_val = CocoLikeDataset()
dataset_val.load_data('../datasets/xview_dataset/xview_data.val.json', '../datasets/xview_dataset/class_ids.json', '../datasets/xview_dataset/train_images')
dataset_val.prepare()
